...
//  Adventurer: Reveal cards from your deck until you reveal 2 Treasure cards. Put those 
//              Treasure cards into your hand and discard the otehr revealed cards.
int adventurerPlayed(struct gameState *state) {
  int currentPlayer = whoseTurn(state);
  int drawntreasure = 0;
  int cardDraw;
  int z = 0;
  ...
  while(drawntreasure<=2){ /*************************** BUG INTRODUCED: "<" --> "<=" *****************************/
    ...
    cardDraw = state->hand[currentPlayer][state->handCount[currentPlayer]-1]; //top card of hand is most recently drawn card
    ...
    if(cardDrawn == copper || cardDrawn == silver || cardDrawn == gold){
      ...
      state->handCount[currentPlayer]--; //this should remove the top card (recently drawn)
      z++;
    }
  }
...
int smithyPlayed(int handPos, struct gameState *state){
  int i = 0;
  int currentPlayer = whoseTurn(state);
